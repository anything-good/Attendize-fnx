        ...
        <div class="col-md-8 col-md-pull-4">
            <div class="event_order_form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label("phone", trans("Public_ViewEvent.phone")) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                              ...
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                    {!! Form::label("phone", trans("Public_ViewEvent.phone")) !!}
                                                    {!! Form::text("ticket_holder_phone[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "ticket_holder_phone.$i.{$ticket['ticket']['id']} ticket_holder_phone form-control"]) !!}
                                                </div>
                                            </div>
...
$(document).ready(function() {
    $('#mirror_buyer_info').on('click', function(e) {
        ...
        $('.ticket_holder_phone').val($('#phone').val());
    });
});
